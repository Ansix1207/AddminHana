...
<%
  ...
  Integer[] accountBalance = new Integer[]{0, 0};
  if (assetDTO != null) {
    accountBalance = assetDTO.getBalance_sum();
  }
  Integer asset = 0;
