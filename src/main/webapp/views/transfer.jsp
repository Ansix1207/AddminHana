...
<body>
  <div class="wrap">
    ...
    <main>
      <form action="계좌이체" method="post" id="transferForm" class="p-5 bg-white">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            ...
            <input type="text" id="counterpart_id" class="form-control">
          </div>
        </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            ...
            <input type="text" id="acc_balance" class="form-control">
          </div>
        </div>
