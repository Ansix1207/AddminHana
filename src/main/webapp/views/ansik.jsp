...
<body>
  <div class="wrap">
    ...
    <main>
      <form action="transfer" method="post" id="transferForm" name="transferForm" class="p-5 bg-white">
        ...
        <div class="row form-group">
          <div class="col-md-8">
            ...
            <input type="text" id="acc_balance" name="acc_balance" class="form-control" readonly>
          </div>
        </div>
        <% } %>
        ...
        <div class="row form-group">
          <div class="col-md-8 mt-2">
            <input type="button" value="계좌 이체" onclick="submitForm()" class="btn btn-primary text-white form-control">
          </div>
        </div>
      </form>
    </main>
